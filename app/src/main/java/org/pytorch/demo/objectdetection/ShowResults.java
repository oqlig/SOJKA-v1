...
public class ShowResults extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customAdapter = new CustomAdapter(ShowResults.this, title, time, instructions, picture);
        ...
        Log.i("guihchgfjgbjhsdbcvdkjkvjxhb", picture.toString());

        myRecyclerView = findViewById(R.id.recyclerView);
        myRecyclerView.setAdapter(customAdapter);
        myRecyclerView.setLayoutManager(new LinearLayoutManager(ShowResults.this));
